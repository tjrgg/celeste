...
module.exports = class extends Command {
	...
	constructor(...args) {
		super(...args, { aliases: [ 'commands' ], description: language => language.get('COMMAND_HELP_DESCRIPTION'), guarded: true, usage: '(Command:command)' });
	...
	async run(message, [ command ]) {
		...
		return message.sendMessage(helpMessage, { split: { char: '\u200b' } });
	}
